...
import React, { Dispatch, useMemo, useReducer, useState, useEffect } from "react";
...
const Patients: React.FC = () => {
  ...
  // BULLETPROOF: Check location.state instead of the URL layout text path string.
  const [view, setView] = useState<"LIST" | "NEW" | "EDIT" | "DETAILS">("LIST");
  const [selectedPatient, setSelectedPatient] = useState<Patient | null>(null);

  // Sync state whenever history navigation triggers a location update
  useEffect(() => {
